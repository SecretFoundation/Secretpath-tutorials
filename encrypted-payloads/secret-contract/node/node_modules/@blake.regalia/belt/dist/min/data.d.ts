 ...
 */
export declare const text_to_buffer: (s_text: string) => Uint8Array;
/**
 * UTF-8 decodes the given Uint8Array to text.
 * @param atu8_text UTF-8 encoded data to decode
 * @returns text
 */
export declare const buffer_to_text: (atu8_text: Uint8Array) => string;
/**
 ...
 */
export declare const text_to_base64: (s_text: string) => string;
/**
 ...
 * @returns UTF-8 encoded Uint8Array
 */
export declare const json_to_buffer: (w_json: JsonValue) => Uint8Array;
/**
 ...
 */
export declare const buffer_to_json: (atu8_json: Uint8Array) => JsonValue;
/**
 * Encodes the given 32-bit integer in big-endian format to a new buffer.
 * @param xg_uint
 * @returns
 */
export declare const uint32_to_buffer_be: (xg_uint: number | bigint) => Uint8Array;
/**
 * Decodes a 32-bit integer in big-endian format from a buffer (optionally at the given position).
 * @param n_uint
 * @returns
 */
export declare const buffer_to_uint32_be: (atu8_buffer: Uint8Array, ib_offset?: number) => number;
/**
 ...
 */
export declare const buffer_to_hex: (atu8_buffer: Uint8Array) => string;
/**
 * Converts the given hex string into a buffer.
 * @param sx_hex input hex string
 * @returns output buffer
 */
export declare const hex_to_buffer: (sx_hex: string) => Uint8Array;
/**
 * Converts the given buffer to a base64-encoded string.
 * @param atu8_buffer input buffer
 * @returns output base64-encoded string
 */
export declare const buffer_to_base64: (atu8_buffer: Uint8Array) => string;
/**
 * Converts the given base64-encoded string to a buffer.
 * @param sx_buffer input base64-encoded string
 * @returns output buffer
 */
export declare const base64_to_buffer: (sx_buffer: string) => Uint8Array;
/**
 * Converts the given UTF-8 friendly compact string to a buffer.
 * @param sx_buffer input string
 * @returns output buffer
 */
export declare const string8_to_buffer: (sx_buffer: string) => Uint8Array;
/**
 * Converts the given buffer to a base93-encoded string.
 * @param atu8_buffer input buffer
 * @returns output base93-encoded string
 */
export declare const buffer_to_base93: (atu8_buffer: Uint8Array) => string;
/**
...
export declare const buffer_to_base58: (atu8_buffer: Uint8Array) => string;
