...
export type EncodedAkashAuditGenesisState = Encoded<'/akash.audit.v1beta2.GenesisState'>;
/**
 ...
 */
export declare const encodeAkashAuditGenesisState: (a_attributes?: Opt<Encoded<'/akash.audit.v1beta2.AuditedAttributes'>[]>) => EncodedAkashAuditGenesisState;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_GENESIS_STATE = "/akash.audit.v1beta2.GenesisState";
/**
 * JSON serialization of `akash.audit.v1beta2.GenesisState` - defines the basic genesis state used by audit module
 */
