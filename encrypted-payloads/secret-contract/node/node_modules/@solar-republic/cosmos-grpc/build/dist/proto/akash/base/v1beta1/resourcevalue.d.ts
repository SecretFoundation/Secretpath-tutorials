...
export type EncodedAkashBaseResourceValue = Encoded<'/akash.base.v1beta1.ResourceValue'>;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_BASE_RESOURCE_VALUE = "/akash.base.v1beta1.ResourceValue";
/**
 * JSON serialization of `akash.base.v1beta1.ResourceValue` - Unit stores cpu, memory and storage metrics
 */
