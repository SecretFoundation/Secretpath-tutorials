...
export type EncodedAkashCertCertificateResponse = Encoded<'/akash.cert.v1beta3.CertificateResponse'>;
export type EncodedAkashCertQueryCertificatesRequest = Encoded<'/akash.cert.v1beta3.QueryCertificatesRequest'>;
export type EncodedAkashCertQueryCertificatesResponse = Encoded<'/akash.cert.v1beta3.QueryCertificatesResponse'>;
/**
 ...
 */
export declare const encodeAkashCertCertificateResponse: (atu8_certificate?: Opt<Encoded<'/akash.cert.v1beta3.Certificate'>>, s_serial?: Opt<string>) => EncodedAkashCertCertificateResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashCertQueryCertificatesRequest: (atu8_filter?: Opt<Encoded<'/akash.cert.v1beta3.CertificateFilter'>>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageRequest'>>) => EncodedAkashCertQueryCertificatesRequest;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashCertQueryCertificatesResponse: (a_certificates?: Opt<Encoded<'/akash.cert.v1beta3.CertificateResponse'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashCertQueryCertificatesResponse;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_CERT_CERTIFICATE_RESPONSE = "/akash.cert.v1beta3.CertificateResponse";
/**
 * JSON serialization of `akash.cert.v1beta3.CertificateResponse` - contains a single X509 certificate and its serial number
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_CERT_QUERY_CERTIFICATES_REQUEST = "/akash.cert.v1beta3.QueryCertificatesRequest";
/**
 * JSON serialization of `akash.cert.v1beta3.QueryCertificatesRequest` - QueryDeploymentsRequest is request type for the Query/Deployments RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_CERT_QUERY_CERTIFICATES_RESPONSE = "/akash.cert.v1beta3.QueryCertificatesResponse";
/**
 * JSON serialization of `akash.cert.v1beta3.QueryCertificatesResponse` - response type for the Query/Certificates RPC method
 */
