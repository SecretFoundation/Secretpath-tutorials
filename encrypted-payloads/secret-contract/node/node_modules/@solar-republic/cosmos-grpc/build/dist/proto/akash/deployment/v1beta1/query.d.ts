...
import type { AkashDeploymentGroup, DecodedAkashDeploymentGroup, AkashDeploymentGroupID, DecodedAkashDeploymentGroupID } from './group.js';
import type { AkashEscrowAccount, DecodedAkashEscrowAccount } from '../../escrow/v1beta1/types.js';
...
export type EncodedAkashDeploymentQueryDeploymentsRequest = Encoded<'/akash.deployment.v1beta1.QueryDeploymentsRequest'>;
export type EncodedAkashDeploymentQueryDeploymentsResponse = Encoded<'/akash.deployment.v1beta1.QueryDeploymentsResponse'>;
export type EncodedAkashDeploymentQueryDeploymentRequest = Encoded<'/akash.deployment.v1beta1.QueryDeploymentRequest'>;
export type EncodedAkashDeploymentQueryDeploymentResponse = Encoded<'/akash.deployment.v1beta1.QueryDeploymentResponse'>;
export type EncodedAkashDeploymentQueryGroupRequest = Encoded<'/akash.deployment.v1beta1.QueryGroupRequest'>;
export type EncodedAkashDeploymentQueryGroupResponse = Encoded<'/akash.deployment.v1beta1.QueryGroupResponse'>;
/**
 * Queries deployments
 ...
 */
export declare const encodeAkashDeploymentQueryDeploymentsRequest: (atu8_filters?: Opt<Encoded<'/akash.deployment.v1beta1.DeploymentFilters'>>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageRequest'>>) => EncodedAkashDeploymentQueryDeploymentsRequest;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryDeploymentsResponse: (a_deployments?: Opt<Encoded<'/akash.deployment.v1beta1.QueryDeploymentResponse'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashDeploymentQueryDeploymentsResponse;
/**
 * Encodes a `QueryDeploymentRequest` protobuf message: request type for the Query/Deployment RPC method
 * @param g_id - `id`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryDeploymentRequest: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta1.DeploymentID'>>) => EncodedAkashDeploymentQueryDeploymentRequest;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryDeploymentResponse: (atu8_deployment?: Opt<Encoded<'/akash.deployment.v1beta1.Deployment'>>, a_groups?: Opt<Encoded<'/akash.deployment.v1beta1.Group'>[]>, atu8_escrow_account?: Opt<Encoded<'/akash.escrow.v1beta1.Account'>>) => EncodedAkashDeploymentQueryDeploymentResponse;
/**
 * Encodes a `QueryGroupRequest` protobuf message: request type for the Query/Group RPC method
 * @param g_id - `id`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryGroupRequest: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta1.GroupID'>>) => EncodedAkashDeploymentQueryGroupRequest;
/**
 * Encodes a `QueryGroupResponse` protobuf message: response type for the Query/Group RPC method
 * @param g_group - `group`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryGroupResponse: (atu8_group?: Opt<Encoded<'/akash.deployment.v1beta1.Group'>>) => EncodedAkashDeploymentQueryGroupResponse;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENTS_REQUEST = "/akash.deployment.v1beta1.QueryDeploymentsRequest";
/**
 * JSON serialization of `akash.deployment.v1beta1.QueryDeploymentsRequest` - request type for the Query/Deployments RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENTS_RESPONSE = "/akash.deployment.v1beta1.QueryDeploymentsResponse";
/**
 * JSON serialization of `akash.deployment.v1beta1.QueryDeploymentsResponse` - response type for the Query/Deployments RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENT_RESPONSE = "/akash.deployment.v1beta1.QueryDeploymentResponse";
/**
 * JSON serialization of `akash.deployment.v1beta1.QueryDeploymentResponse` - response type for the Query/Deployment RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENT_REQUEST = "/akash.deployment.v1beta1.QueryDeploymentRequest";
/**
 * JSON serialization of `akash.deployment.v1beta1.QueryDeploymentRequest` - request type for the Query/Deployment RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_GROUP_REQUEST = "/akash.deployment.v1beta1.QueryGroupRequest";
/**
 * JSON serialization of `akash.deployment.v1beta1.QueryGroupRequest` - request type for the Query/Group RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_GROUP_RESPONSE = "/akash.deployment.v1beta1.QueryGroupResponse";
/**
 * JSON serialization of `akash.deployment.v1beta1.QueryGroupResponse` - response type for the Query/Group RPC method
 */
