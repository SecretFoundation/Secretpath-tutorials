...
export type EncodedAkashDeploymentMsgCreateDeployment = Encoded<'/akash.deployment.v1beta2.MsgCreateDeployment'>;
export type EncodedAkashDeploymentMsgCreateDeploymentResponse = Encoded<'/akash.deployment.v1beta2.MsgCreateDeploymentResponse'>;
export type EncodedAkashDeploymentMsgDepositDeployment = Encoded<'/akash.deployment.v1beta2.MsgDepositDeployment'>;
export type EncodedAkashDeploymentMsgDepositDeploymentResponse = Encoded<'/akash.deployment.v1beta2.MsgDepositDeploymentResponse'>;
export type EncodedAkashDeploymentMsgUpdateDeployment = Encoded<'/akash.deployment.v1beta2.MsgUpdateDeployment'>;
export type EncodedAkashDeploymentMsgUpdateDeploymentResponse = Encoded<'/akash.deployment.v1beta2.MsgUpdateDeploymentResponse'>;
export type EncodedAkashDeploymentMsgCloseDeployment = Encoded<'/akash.deployment.v1beta2.MsgCloseDeployment'>;
export type EncodedAkashDeploymentMsgCloseDeploymentResponse = Encoded<'/akash.deployment.v1beta2.MsgCloseDeploymentResponse'>;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentMsgDepositDeployment: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta2.DeploymentID'>>, a_amount?: Opt<SlimCoin>, sa_depositor?: Opt<WeakAccountAddr>) => EncodedAkashDeploymentMsgDepositDeployment;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentMsgUpdateDeployment: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta2.DeploymentID'>>, atu8_version?: Opt<Uint8Array>) => EncodedAkashDeploymentMsgUpdateDeployment;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentMsgCloseDeployment: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta2.DeploymentID'>>) => EncodedAkashDeploymentMsgCloseDeployment;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_CREATE_DEPLOYMENT = "/akash.deployment.v1beta2.MsgCreateDeployment";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgCreateDeployment` - defines an SDK message for creating deployment
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_CREATE_DEPLOYMENT_RESPONSE = "/akash.deployment.v1beta2.MsgCreateDeploymentResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgCreateDeploymentResponse` - defines the Msg/CreateDeployment response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_DEPOSIT_DEPLOYMENT = "/akash.deployment.v1beta2.MsgDepositDeployment";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgDepositDeployment` - deposits more funds into the deposit account
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_DEPOSIT_DEPLOYMENT_RESPONSE = "/akash.deployment.v1beta2.MsgDepositDeploymentResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgDepositDeploymentResponse` - MsgCreateDeploymentResponse defines the Msg/CreateDeployment response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_UPDATE_DEPLOYMENT = "/akash.deployment.v1beta2.MsgUpdateDeployment";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgUpdateDeployment` - defines an SDK message for updating deployment
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_UPDATE_DEPLOYMENT_RESPONSE = "/akash.deployment.v1beta2.MsgUpdateDeploymentResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgUpdateDeploymentResponse` - defines the Msg/UpdateDeployment response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_CLOSE_DEPLOYMENT = "/akash.deployment.v1beta2.MsgCloseDeployment";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgCloseDeployment` - defines an SDK message for closing deployment
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_CLOSE_DEPLOYMENT_RESPONSE = "/akash.deployment.v1beta2.MsgCloseDeploymentResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgCloseDeploymentResponse` - defines the Msg/CloseDeployment response type.
 */
