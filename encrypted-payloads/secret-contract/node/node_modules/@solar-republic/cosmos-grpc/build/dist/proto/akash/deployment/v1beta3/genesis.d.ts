...
export type EncodedAkashDeploymentGenesisDeployment = Encoded<'/akash.deployment.v1beta3.GenesisDeployment'>;
export type EncodedAkashDeploymentGenesisState = Encoded<'/akash.deployment.v1beta3.GenesisState'>;
/**
 ...
 */
export declare const encodeAkashDeploymentGenesisDeployment: (atu8_deployment?: Opt<Encoded<'/akash.deployment.v1beta3.Deployment'>>, a_groups?: Opt<Encoded<'/akash.deployment.v1beta3.Group'>[]>) => EncodedAkashDeploymentGenesisDeployment;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentGenesisState: (a_deployments?: Opt<Encoded<'/akash.deployment.v1beta3.GenesisDeployment'>[]>, atu8_params?: Opt<Encoded<'/akash.deployment.v1beta3.Params'>>) => EncodedAkashDeploymentGenesisState;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_GENESIS_DEPLOYMENT = "/akash.deployment.v1beta3.GenesisDeployment";
/**
 * JSON serialization of `akash.deployment.v1beta3.GenesisDeployment` - defines the basic genesis state used by deployment module
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_GENESIS_STATE = "/akash.deployment.v1beta3.GenesisState";
/**
 * JSON serialization of `akash.deployment.v1beta3.GenesisState` - stores slice of genesis deployment instance
 */
