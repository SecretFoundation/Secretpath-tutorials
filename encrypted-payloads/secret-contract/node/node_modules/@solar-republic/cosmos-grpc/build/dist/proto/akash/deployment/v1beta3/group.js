 ...
 */
export const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_GROUP = '/akash.deployment.v1beta3.Group';
/**
 * Protobuf enum value for `akash.deployment.v1beta3.Group.State`.
 *
 * **invalid** -
 *
...
/**
 * JSON enum value for `akash.deployment.v1beta3.Group.State`.
 *
 * **invalid** -
 *
...
/**
 * Maps a protobuf enum int value for `akash.deployment.v1beta3.Group.State` to is JSON equivalent enum string value
 */
...
/**
 * Maps a JSON enum string value for `akash.deployment.v1beta3.Group.State` to is protobuf equivalent enum int value
 */
