...
import { decodeAkashBasePlacementRequirements } from '../../base/v1beta3/attribute.js';
import { decodeAkashDeploymentResourceUnit } from './resourceunit.js';
/**
...
export const encodeAkashDeploymentGroupSpec = (s_name, atu8_requirements, a_resources) => Protobuf() // ...
    ...
    .B(a_resources) // ResourceUnit[] resources = 3
    .o;
/**
 ...
 */
export const decodeAkashDeploymentGroupSpec = (atu8_payload) => decode_protobuf(atu8_payload, [5, 1, 0], [0, decodeAkashBasePlacementRequirements, decodeAkashDeploymentResourceUnit]);
/**
 ...
 */
export const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_GROUP_SPEC = '/akash.deployment.v1beta3.GroupSpec';
