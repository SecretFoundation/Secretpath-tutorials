...
export type EncodedAkashEscrowAccountID = Encoded<'/akash.escrow.v1beta3.AccountID'>;
export type EncodedAkashEscrowAccount = Encoded<'/akash.escrow.v1beta3.Account'>;
export type EncodedAkashEscrowFractionalPayment = Encoded<'/akash.escrow.v1beta3.FractionalPayment'>;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashEscrowFractionalPayment: (atu8_account_id?: Opt<Encoded<'/akash.escrow.v1beta3.AccountID'>>, si_payment?: Opt<string>, sa_owner?: Opt<WeakAccountAddr>, xc_state?: Opt<ProtoEnumAkashEscrowFractionalPaymentState>, atu8_rate?: Opt<Encoded<'/cosmos.base.v1beta1.DecCoin'>>, atu8_balance?: Opt<Encoded<'/cosmos.base.v1beta1.DecCoin'>>, a_withdrawn?: Opt<SlimCoin>) => EncodedAkashEscrowFractionalPayment;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_ACCOUNT = "/akash.escrow.v1beta3.Account";
/**
 * JSON serialization of `akash.escrow.v1beta3.Account` - stores state for an escrow account
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_ACCOUNT_I_D = "/akash.escrow.v1beta3.AccountID";
/**
 * JSON serialization of `akash.escrow.v1beta3.AccountID` - the account identifier
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_FRACTIONAL_PAYMENT = "/akash.escrow.v1beta3.FractionalPayment";
/**
 * JSON serialization of `akash.escrow.v1beta3.FractionalPayment` - Payment stores state for a payment
 */
...
/**
 * Raw protobuf enum values for `akash.escrow.v1beta3.Account.State` to be used when passing to an encoder or comparing to a decoded protobuf value.
 *
 * Values:
...
/**
 * JSON enum values for `akash.escrow.v1beta3.Account.State` to be used when passing to a gRPC-gateway method or comparing to a response value
 *
 * Values:
...
/**
 * Raw protobuf enum values for `akash.escrow.v1beta3.FractionalPayment.State` to be used when passing to an encoder or comparing to a decoded protobuf value.
 *
 * Values:
...
/**
 * JSON enum values for `akash.escrow.v1beta3.FractionalPayment.State` to be used when passing to a gRPC-gateway method or comparing to a response value
 *
 * Values:
