...
export type EncodedAkashProviderQueryProvidersRequest = Encoded<'/akash.provider.v1beta2.QueryProvidersRequest'>;
export type EncodedAkashProviderQueryProvidersResponse = Encoded<'/akash.provider.v1beta2.QueryProvidersResponse'>;
export type EncodedAkashProviderQueryProviderRequest = Encoded<'/akash.provider.v1beta2.QueryProviderRequest'>;
export type EncodedAkashProviderQueryProviderResponse = Encoded<'/akash.provider.v1beta2.QueryProviderResponse'>;
/**
 * Queries providers
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashProviderQueryProvidersResponse: (a_providers?: Opt<Encoded<'/akash.provider.v1beta2.Provider'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashProviderQueryProvidersResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashProviderQueryProviderResponse: (atu8_provider?: Opt<Encoded<'/akash.provider.v1beta2.Provider'>>) => EncodedAkashProviderQueryProviderResponse;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_PROVIDER_QUERY_PROVIDERS_REQUEST = "/akash.provider.v1beta2.QueryProvidersRequest";
/**
 * JSON serialization of `akash.provider.v1beta2.QueryProvidersRequest` - request type for the Query/Providers RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_PROVIDER_QUERY_PROVIDERS_RESPONSE = "/akash.provider.v1beta2.QueryProvidersResponse";
/**
 * JSON serialization of `akash.provider.v1beta2.QueryProvidersResponse` - response type for the Query/Providers RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_PROVIDER_QUERY_PROVIDER_REQUEST = "/akash.provider.v1beta2.QueryProviderRequest";
/**
 * JSON serialization of `akash.provider.v1beta2.QueryProviderRequest` - request type for the Query/Provider RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_PROVIDER_QUERY_PROVIDER_RESPONSE = "/akash.provider.v1beta2.QueryProviderResponse";
/**
 * JSON serialization of `akash.provider.v1beta2.QueryProviderResponse` - response type for the Query/Provider RPC method
 */
