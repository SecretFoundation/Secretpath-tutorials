...
export type EncodedOsmosisConcentratedliquidityParams = Encoded<'/osmosis.concentratedliquidity.Params'>;
/**
 ...
 */
export declare const encodeOsmosisConcentratedliquidityParams: (a_authorized_tick_spacings?: Opt<WeakUint64Str[]>, a_authorized_spread_factors?: Opt<string[]>, s_balancer_shares_reward_discount?: Opt<string>, a_authorized_quote_denoms?: Opt<string[]>, a_authorized_uptimes?: Opt<number[]>, b_is_permissionless_pool_creation_enabled?: Opt<boolean | 0 | 1>, a_unrestricted_pool_creator_whitelists?: Opt<string[]>) => EncodedOsmosisConcentratedliquidityParams;
/**
 ...
 */
export type DecodedOsmosisConcentratedliquidityParams = [
    a_authorized_tick_spacings?: CwUint64[],
    a_authorized_spread_factors?: string[],
    s_balancer_shares_reward_discount?: string,
    a_authorized_quote_denoms?: string[],
    a_authorized_uptimes?: [
        string,
        number
    ][],
    b_is_permissionless_pool_creation_enabled?: 0 | 1,
    a_unrestricted_pool_creator_whitelists?: string[]
];
/**
 ...
 */
export declare const decodeOsmosisConcentratedliquidityParams: (atu8_payload: Uint8Array) => DecodedOsmosisConcentratedliquidityParams;
/**
 ...
 *   - 6: unrestricted_pool_creator_whitelist - a list of addresses that are allowed to bypass restrictions on permissionless supercharged pool creation, like pool_creation_enabled, restricted quote assets, no double creation of pools, etc.
 */
export declare const destructOsmosisConcentratedliquidityParams: (g_struct: OsmosisConcentratedliquidityParams) => [authorized_tick_spacing?: CwUint64[], authorized_spread_factors?: string[], balancer_shares_reward_discount?: string, authorized_quote_denoms?: string[], authorized_uptimes?: number[], is_permissionless_pool_creation_enabled?: boolean, unrestricted_pool_creator_whitelist?: string[]];
/**
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_OSMOSIS_CONCENTRATEDLIQUIDITY_PARAMS = "/osmosis.concentratedliquidity.Params";
/**
 * JSON serialization of `osmosis.concentratedliquidity.Params` -
 */
export type OsmosisConcentratedliquidityParams = {
    authorized_tick_spacing?: CwUint64[] | undefined;
    authorized_spread_factors?: string[] | undefined;
    balancer_shares_reward_discount?: string | undefined;
    authorized_quote_denoms?: string[] | undefined;
    authorized_uptimes?: WeakDurationStr[] | undefined;
    is_permissionless_pool_creation_enabled?: boolean | undefined;
    unrestricted_pool_creator_whitelist?: string[] | undefined;
};
