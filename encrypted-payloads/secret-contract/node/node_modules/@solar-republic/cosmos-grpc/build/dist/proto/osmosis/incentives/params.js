 ...
 */
export const encodeOsmosisIncentivesParams = (s_distr_epoch_identifier, a_group_creation_fees, a_unrestricted_creator_whitelists) => Protobuf() // ...
    .s(s_distr_epoch_identifier) // string distr_epoch_identifier = 1
    .B(coins(a_group_creation_fees)) // Coin[] group_creation_fee = 2
    .S(a_unrestricted_creator_whitelists) // string[] unrestricted_creator_whitelist = 3
    .o;
/**
 ...
 */
export const decodeOsmosisIncentivesParams = (atu8_payload) => decode_protobuf(atu8_payload, [5, 0, 4], [0, decode_coin]);
/**
 ...
 */
export const destructOsmosisIncentivesParams = (g_struct) => [g_struct.distr_epoch_identifier, g_struct.group_creation_fee, g_struct.unrestricted_creator_whitelist];
/**
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_OSMOSIS_INCENTIVES_PARAMS = '/osmosis.incentives.Params';
