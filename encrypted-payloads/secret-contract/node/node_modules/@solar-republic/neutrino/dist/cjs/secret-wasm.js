import { bytes, ATU8_NIL, base64_to_bytes, bytes_to_text, concat2, text_to_bytes, } from '@blake.regalia/belt';
...
export const SecretWasm = (atu8_consensus_pk, atu8_seed) => {
    atu8_seed = atu8_seed || random_32();
    if (32 !== atu8_consensus_pk.byteLength)
        die(`Invalid consensus key length`);
    if (32 !== atu8_seed.byteLength)
        die(`Invalid seed length`);
...
//# sourceMappingURL=secret-wasm.js.map