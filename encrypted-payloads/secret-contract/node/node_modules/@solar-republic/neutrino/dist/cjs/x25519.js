...
const sel25519 = (atf64_p, atf64_q, xn_b) => {
    let i_f;
    let xn_t;
    const xn_c = ~(xn_b - 1);
    for (i_f = 0; i_f < 16; i_f++) {
...
const add = (atf64_out, atf64_a, atf64_b) => {
    for (let i_f = 0; i_f < 16; i_f++) {
        atf64_out[i_f] = atf64_a[i_f] + atf64_b[i_f];
    }
};
const sub = (atf64_out, atf64_a, atf64_b) => {
    for (let i_f = 0; i_f < 16; i_f++) {
        atf64_out[i_f] = atf64_a[i_f] - atf64_b[i_f];
    }
};
const add_sub = (atf64_out, atf64_a, atf64_b) => (add(atf64_out, atf64_a, atf64_b),
    sub(atf64_a, atf64_a, atf64_b));
const mul = (atf64_out, atf64_a, atf64_b) => {
    let i_f;
    let i_ff;
...
const square = (atu8_out, atu8_a) => mul(atu8_out, atu8_a, atu8_a);
/**
 ...
 * @returns
 */
export const ecs_mul = (atu8_n, atu8_p) => {
    init_base();
 ...
 * @returns
 */
export const ecs_mul_base = (atu8_n) => ecs_mul(atu8_n, ATU8_BASE || init_base());
