...
const transcrypt = (atu8_key, atu8_nonce, atu8_data) => [
...
const poly1305_auth = (atu8_poly1305_key, atu8_ciphertext, atu8_aad) => {
    // normalize aad
    atu8_aad ||= bytes(0);
 ...
 */
export const chacha20_poly1305_seal = (atu8_key, atu8_nonce, atu8_plaintext, atu8_aad) => {
    // encrypt
    let [atu8_poly1305_key, atu8_ciphertext,] = transcrypt(atu8_key, atu8_nonce, atu8_plaintext);
 ...
 * @returns
 */
export const chacha20_poly1305_open = (atu8_key, atu8_nonce, atu8_tag, atu8_ciphertext, atu8_aad) => {
    // decrypt
    let [atu8_poly1305_key, atu8_plaintext,] = transcrypt(atu8_key, atu8_nonce, atu8_ciphertext);
    // generate expected tag
    let atu8_tag_expected = poly1305_auth(atu8_poly1305_key, atu8_ciphertext, atu8_aad);
    // mismatch
    if (bytes_to_base64(atu8_tag_expected) !== bytes_to_base64(atu8_tag))
        die('Tag mismatch; tampered or incomplete data');
    // return plaintext
