import { MauthQuerier, MsgBeginRedelegateParams, MsgCreateValidatorParams, MsgDelegateParams, MsgDepositParams, MsgEditValidatorParams, MsgExecParams, MsgExecuteContractParams, MsgFundCommunityPoolParams, MsgGrantAllowanceParams, MsgGrantParams, MsgInstantiateContractParams, MsgMultiSendParams, MsgRevokeAllowanceParams, MsgRevokeParams, MsgSendParams, MsgSetWithdrawAddressParams, MsgStoreCodeParams, MsgSubmitEvidenceParams, MsgSubmitProposalParams, MsgTransferParams, MsgUndelegateParams, MsgUnjailParams, MsgUpdateAdminParams, MsgVoteParams, MsgVoteWeightedParams, MsgWithdrawDelegatorRewardParams, MsgWithdrawValidatorCommissionParams, NodeQuerier } from "secretjs/src";
import { EncryptionUtils } from "secretjs/src/encryption";
import { PermitSigner } from "secretjs/src/extensions/access_control/permit/permit_signer";
import { CreateViewingKeyContractParams, SetViewingKeyContractParams } from "secretjs/src/extensions/access_control/viewing_key/params";
import { Snip1155Querier } from "secretjs/src/extensions/snip1155/query";
import { Snip1155AddCuratorOptions, Snip1155AddMinterOptions, Snip1155BatchSendOptions, Snip1155BatchTransferOptions, Snip1155BurnTokensOptions, Snip1155ChangeAdminOptions, Snip1155ChangeMetaDataOptions, Snip1155CurateTokensOptions, Snip1155MintTokensOptions, Snip1155RemoveAdminOptions, Snip1155RemoveCuratorOptions, Snip1155RemoveMinterOptions, Snip1155SendOptions, Snip1155TransferOptions } from "secretjs/src/extensions/snip1155/types";
import { Snip20Querier } from "secretjs/src/extensions/snip20";
import { Snip20DecreaseAllowanceOptions, Snip20IncreaseAllowanceOptions, Snip20SendOptions, Snip20TransferOptions } from "secretjs/src/extensions/snip20/types";
import { Snip721Querier } from "secretjs/src/extensions/snip721";
import { Snip721AddMinterOptions, Snip721MintOptions, Snip721SendOptions } from "secretjs/src/extensions/snip721/types";
import { PageRequest } from "secretjs/src/grpc_gateway/cosmos/base/query/v1beta1/pagination.pb";
import { OrderBy, SimulateResponse } from "secretjs/src/grpc_gateway/cosmos/tx/v1beta1/service.pb";
import { Tx as TxPb } from "secretjs/src/grpc_gateway/cosmos/tx/v1beta1/tx.pb";
import { AuthQuerier } from "secretjs/src/query/auth";
import { AuthzQuerier } from "secretjs/src/query/authz";
import { BankQuerier } from "secretjs/src/query/bank";
import { ComputeQuerier } from "secretjs/src/query/compute";
import { DistributionQuerier } from "secretjs/src/query/distribution";
import { EmergencyButtonQuerier } from "secretjs/src/query/emergency_button";
import { EvidenceQuerier } from "secretjs/src/query/evidence";
import { FeegrantQuerier } from "secretjs/src/query/feegrant";
import { GovQuerier } from "secretjs/src/query/gov";
import { IbcChannelQuerier } from "secretjs/src/query/ibc_channel";
import { IbcClientQuerier } from "secretjs/src/query/ibc_client";
import { IbcConnectionQuerier } from "secretjs/src/query/ibc_connection";
import { IbcFeeQuerier } from "secretjs/src/query/ibc_fee";
import { IbcInterchainAccountsControllerQuerier } from "secretjs/src/query/ibc_interchain_accounts_controller";
import { IbcInterchainAccountsHostQuerier } from "secretjs/src/query/ibc_interchain_accounts_host";
import { IbcPacketForwardQuerier } from "secretjs/src/query/ibc_packet_forward";
import { IbcTransferQuerier } from "secretjs/src/query/ibc_transfer";
import { MintQuerier } from "secretjs/src/query/mint";
import { ParamsQuerier } from "secretjs/src/query/params";
import { RegistrationQuerier } from "secretjs/src/query/registration";
import { SlashingQuerier } from "secretjs/src/query/slashing";
import { StakingQuerier } from "secretjs/src/query/staking";
import { TendermintQuerier } from "secretjs/src/query/tendermint";
import { UpgradeQuerier } from "secretjs/src/query/upgrade";
import { Msg, MsgClearAdminParams, MsgMigrateContractParams, MsgPayPacketFeeAsyncParams, MsgPayPacketFeeParams, MsgRegisterCounterpartyPayeeParams, MsgRegisterPayeeParams, MsgSetAutoRestakeParams } from "secretjs/src/tx";
import { MsgToggleIbcSwitchParams } from "secretjs/src/tx/emergency_button";
import { RaAuthenticateParams } from "secretjs/src/tx/registration";
import { MsgCreateVestingAccountParams } from "secretjs/src/tx/vesting";
import { AccountData, AminoSignResponse, AminoSigner, Signer, StdSignDoc } from "secretjs/src/wallet_amino";
...
export declare type TxResponse = {
     ...
     */
    readonly events: Array<import("secretjs/src/grpc_gateway/tendermint/abci/types.pb").Event>;
