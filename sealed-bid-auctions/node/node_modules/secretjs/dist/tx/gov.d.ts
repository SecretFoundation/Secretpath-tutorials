import { Coin, MsgParams } from "secretjs/src";
import { AminoMsg, Msg, ProtoMsg } from "secretjs/src/tx/types";
export declare type ProposalContent = import("secretjs/src/protobuf/cosmos/gov/v1beta1/gov").TextProposal | import("secretjs/src/protobuf/cosmos/distribution/v1beta1/distribution").CommunityPoolSpendProposal | import("secretjs/src/protobuf/cosmos/params/v1beta1/params").ParameterChangeProposal | import("secretjs/src/protobuf/ibc/core/client/v1/client").ClientUpdateProposal | import("secretjs/src/protobuf/ibc/core/client/v1/client").UpgradeProposal | import("secretjs/src/protobuf/cosmos/upgrade/v1beta1/upgrade").SoftwareUpgradeProposal | import("secretjs/src/protobuf/cosmos/upgrade/v1beta1/upgrade").CancelSoftwareUpgradeProposal;
