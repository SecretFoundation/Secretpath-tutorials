...
export declare class MsgUpdateClient implements Msg {
    private msg;
    constructor(msg: import("secretjs/src/protobuf/ibc/core/client/v1/tx").MsgUpdateClient);
...
export declare class MsgUpgradeClient implements Msg {
    private msg;
    constructor(msg: import("secretjs/src/protobuf/ibc/core/client/v1/tx").MsgUpgradeClient);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
...
export declare class MsgSubmitMisbehaviour implements Msg {
    private msg;
    constructor(msg: import("secretjs/src/protobuf/ibc/core/client/v1/tx").MsgSubmitMisbehaviour);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
...
export declare class MsgCreateClient implements Msg {
    private msg;
    constructor(msg: import("secretjs/src/protobuf/ibc/core/client/v1/tx").MsgCreateClient);
    toProto(): Promise<ProtoMsg>;
    toAmino(): Promise<AminoMsg>;
}
