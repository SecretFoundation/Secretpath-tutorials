import { AminoMsg, Coin, SignDocCamelCase } from "secretjs/src";
...
export declare type DirectSigner = {
    ...
    readonly signDirect: (signerAddress: string, signDoc: import("secretjs/src/protobuf/cosmos/tx/v1beta1/tx").SignDoc | SignDocCamelCase) => Promise<DirectSignResponse>;
};
export declare function isSignDoc(object: any): object is import("secretjs/src/protobuf/cosmos/tx/v1beta1/tx").SignDoc;
...
export declare type DirectSignResponse = {
     ...
     * This may be different from the input signDoc when the signer modifies it as part of the signing process.
     */
    readonly signed: import("secretjs/src/protobuf/cosmos/tx/v1beta1/tx").SignDoc | SignDocCamelCase;
    readonly signature: StdSignature;
};
...
export interface AminoSigner {
     ...
     */
    readonly getSignMode?: () => Promise<import("secretjs/src/protobuf/cosmos/tx/signing/v1beta1/signing").SignMode>;
    /**
