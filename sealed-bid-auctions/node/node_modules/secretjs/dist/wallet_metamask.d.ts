import { AccountData, AminoSignResponse, StdSignDoc } from "secretjs/src/wallet_amino";
/**
...
export declare class MetaMaskWallet {
    ...
    getSignMode(): Promise<import("secretjs/src/protobuf/cosmos/tx/signing/v1beta1/signing").SignMode>;
