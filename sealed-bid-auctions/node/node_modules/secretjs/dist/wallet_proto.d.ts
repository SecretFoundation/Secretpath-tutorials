import { AminoWallet, StdSignature } from "secretjs/src/wallet_amino";
/**
...
export declare class Wallet extends AminoWallet {
    signDirect(address: string, signDoc: import("secretjs/src/protobuf/cosmos/tx/v1beta1/tx").SignDoc): Promise<DirectSignResponse>;
}
declare type DirectSignResponse = {
     ...
     */
    readonly signed: import("secretjs/src/protobuf/cosmos/tx/v1beta1/tx").SignDoc;
