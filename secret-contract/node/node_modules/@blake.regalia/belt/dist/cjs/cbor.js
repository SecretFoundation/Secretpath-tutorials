...
exports.cbor_decode_trivial = void 0;
 ...
 */
const cbor_decode_trivial = (atu8_data, ib_read = 0) => {
    ...
    let dv_data = (0, data_js_1.dataview)(atu8_data.buffer);
    ...
    let a_parsers = [
        ...
        f_bytes,
        // text string
        (_) => (0, data_js_1.bytes_to_text)(a_parsers[2]()),
        // array
        (a_items = []) => {
            for (let i_item = 0; i_item < xn_value; i_item++) {
                [a_items[i_item], ib_read] = (0, exports.cbor_decode_trivial)(atu8_data, ib_read);
            }
            return a_items;
        },
        // map
        (hm_out = new Map()) => {
            for (let i_item = 0, z_key, z_value; i_item < xn_value; i_item++) {
                [z_key, ib_read] = (0, exports.cbor_decode_trivial)(atu8_data, ib_read);
                [z_value, ib_read] = (0, exports.cbor_decode_trivial)(atu8_data, ib_read);
                // save entry to map
...
exports.cbor_decode_trivial = cbor_decode_trivial;
