...
export type EncodedAkashAuditQueryProvidersResponse = Encoded<'/akash.audit.v1beta2.QueryProvidersResponse'>;
export type EncodedAkashAuditQueryProviderRequest = Encoded<'/akash.audit.v1beta2.QueryProviderRequest'>;
export type EncodedAkashAuditQueryAllProvidersAttributesRequest = Encoded<'/akash.audit.v1beta2.QueryAllProvidersAttributesRequest'>;
export type EncodedAkashAuditQueryProviderAttributesRequest = Encoded<'/akash.audit.v1beta2.QueryProviderAttributesRequest'>;
export type EncodedAkashAuditQueryProviderAuditorRequest = Encoded<'/akash.audit.v1beta2.QueryProviderAuditorRequest'>;
export type EncodedAkashAuditQueryAuditorAttributesRequest = Encoded<'/akash.audit.v1beta2.QueryAuditorAttributesRequest'>;
/**
 ...
 */
export declare const encodeAkashAuditQueryProvidersResponse: (a_providers?: Opt<Encoded<'/akash.audit.v1beta2.Provider'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashAuditQueryProvidersResponse;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_QUERY_PROVIDERS_RESPONSE = "/akash.audit.v1beta2.QueryProvidersResponse";
/**
 * JSON serialization of `akash.audit.v1beta2.QueryProvidersResponse` - response type for the Query/Providers RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_QUERY_PROVIDER_REQUEST = "/akash.audit.v1beta2.QueryProviderRequest";
/**
 * JSON serialization of `akash.audit.v1beta2.QueryProviderRequest` - request type for the Query/Provider RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_QUERY_ALL_PROVIDERS_ATTRIBUTES_REQUEST = "/akash.audit.v1beta2.QueryAllProvidersAttributesRequest";
/**
 * JSON serialization of `akash.audit.v1beta2.QueryAllProvidersAttributesRequest` - request type for the Query/All Providers RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_QUERY_PROVIDER_ATTRIBUTES_REQUEST = "/akash.audit.v1beta2.QueryProviderAttributesRequest";
/**
 * JSON serialization of `akash.audit.v1beta2.QueryProviderAttributesRequest` - request type for the Query/Provider RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_QUERY_PROVIDER_AUDITOR_REQUEST = "/akash.audit.v1beta2.QueryProviderAuditorRequest";
/**
 * JSON serialization of `akash.audit.v1beta2.QueryProviderAuditorRequest` - request type for the Query/Providers RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_AUDIT_QUERY_AUDITOR_ATTRIBUTES_REQUEST = "/akash.audit.v1beta2.QueryAuditorAttributesRequest";
/**
 * JSON serialization of `akash.audit.v1beta2.QueryAuditorAttributesRequest` - request type for the Query/Providers RPC method
 */
