...
export type EncodedAkashBaseAttribute = Encoded<'/akash.base.v1beta2.Attribute'>;
export type EncodedAkashBaseSignedBy = Encoded<'/akash.base.v1beta2.SignedBy'>;
export type EncodedAkashBasePlacementRequirements = Encoded<'/akash.base.v1beta2.PlacementRequirements'>;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashBasePlacementRequirements: (atu8_signed_by?: Opt<Encoded<'/akash.base.v1beta2.SignedBy'>>, a_attributes?: Opt<Encoded<'/akash.base.v1beta2.Attribute'>[]>) => EncodedAkashBasePlacementRequirements;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_BASE_ATTRIBUTE = "/akash.base.v1beta2.Attribute";
/**
 * JSON serialization of `akash.base.v1beta2.Attribute` - represents key value pair
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_BASE_PLACEMENT_REQUIREMENTS = "/akash.base.v1beta2.PlacementRequirements";
/**
 * JSON serialization of `akash.base.v1beta2.PlacementRequirements` -
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_BASE_SIGNED_BY = "/akash.base.v1beta2.SignedBy";
/**
 * JSON serialization of `akash.base.v1beta2.SignedBy` - represents validation accounts that tenant expects signatures for provider attributes AllOf has precedence i.e. if there is at least one entry AnyOf is ignored regardless to how many entries there this behaviour to be discussed
 */
