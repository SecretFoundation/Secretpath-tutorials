 ...
 */
export const encodeAkashBaseAttribute = (s_key, s_value) => Protobuf() // ...
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export const encodeAkashBaseSignedBy = (a_all_ofs, a_any_ofs) => Protobuf() // ...
    .S(a_all_ofs) // string[] all_of = 1
    .S(a_any_ofs) // string[] any_of = 2
    .o;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export const encodeAkashBasePlacementRequirements = (atu8_signed_by, a_attributes) => Protobuf() // ...
    .b(atu8_signed_by) // SignedBy signed_by = 1
 ...
 */
export const decodeAkashBaseAttribute = (atu8_payload) => decode_protobuf(atu8_payload, [5, 5]);
/**
 * Decodes a protobuf SignedBy message
 * @param atu8_payload - raw bytes to decode
 * @returns a {@link DecodedAkashBaseSignedBy}
 */
export const decodeAkashBaseSignedBy = (atu8_payload) => decode_protobuf(atu8_payload, [4, 4]);
/**
 * Decodes a protobuf PlacementRequirements message
 * @param atu8_payload - raw bytes to decode
 * @returns a {@link DecodedAkashBasePlacementRequirements}
 */
export const decodeAkashBasePlacementRequirements = (atu8_payload) => decode_protobuf(atu8_payload, [1, 0], [decodeAkashBaseSignedBy, decodeAkashBaseAttribute]);
/**
 ...
 *   - 1: value -
 */
export const destructAkashBaseAttribute = (g_struct) => [g_struct.key, g_struct.value];
/**
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_AKASH_BASE_ATTRIBUTE = '/akash.base.v1beta2.Attribute';
/**
 ...
 */
export const destructAkashBasePlacementRequirements = (g_struct) => [g_struct.signed_by, g_struct.attributes];
/**
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_AKASH_BASE_PLACEMENT_REQUIREMENTS = '/akash.base.v1beta2.PlacementRequirements';
/**
 ...
 */
export const destructAkashBaseSignedBy = (g_struct) => [g_struct.all_of, g_struct.any_of];
/**
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_AKASH_BASE_SIGNED_BY = '/akash.base.v1beta2.SignedBy';
