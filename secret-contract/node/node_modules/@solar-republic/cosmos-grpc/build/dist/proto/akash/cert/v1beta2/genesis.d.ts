...
export type EncodedAkashCertGenesisCertificate = Encoded<'/akash.cert.v1beta2.GenesisCertificate'>;
export type EncodedAkashCertGenesisState = Encoded<'/akash.cert.v1beta2.GenesisState'>;
/**
 ...
 */
export declare const encodeAkashCertGenesisCertificate: (sa_owner?: Opt<WeakAccountAddr>, atu8_certificate?: Opt<Encoded<'/akash.cert.v1beta2.Certificate'>>) => EncodedAkashCertGenesisCertificate;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashCertGenesisState: (a_certificates?: Opt<Encoded<'/akash.cert.v1beta2.GenesisCertificate'>[]>) => EncodedAkashCertGenesisState;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_CERT_GENESIS_CERTIFICATE = "/akash.cert.v1beta2.GenesisCertificate";
/**
 * JSON serialization of `akash.cert.v1beta2.GenesisCertificate` - defines certificate entry at genesis
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_CERT_GENESIS_STATE = "/akash.cert.v1beta2.GenesisState";
/**
 * JSON serialization of `akash.cert.v1beta2.GenesisState` - defines the basic genesis state used by cert module
 */
