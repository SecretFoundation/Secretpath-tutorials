...
export type EncodedAkashDeploymentDepositDeploymentAuthorization = Encoded<'/akash.deployment.v1beta2.DepositDeploymentAuthorization' | 'Authorization'>;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_DEPOSIT_DEPLOYMENT_AUTHORIZATION = "/akash.deployment.v1beta2.DepositDeploymentAuthorization";
/**
 * JSON serialization of `akash.deployment.v1beta2.DepositDeploymentAuthorization` - allows the grantee to deposit up to spend_limit coins from the granter's account for a deployment.
 */
