...
export type EncodedAkashDeploymentDeploymentID = Encoded<'/akash.deployment.v1beta2.DeploymentID'>;
export type EncodedAkashDeploymentDeployment = Encoded<'/akash.deployment.v1beta2.Deployment'>;
export type EncodedAkashDeploymentDeploymentFilters = Encoded<'/akash.deployment.v1beta2.DeploymentFilters'>;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentDeployment: (atu8_deployment_id?: Opt<Encoded<'/akash.deployment.v1beta2.DeploymentID'>>, xc_state?: Opt<ProtoEnumAkashDeploymentDeploymentState>, atu8_version?: Opt<Uint8Array>, sg_created_at?: Opt<WeakInt64Str>) => EncodedAkashDeploymentDeployment;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_DEPLOYMENT_I_D = "/akash.deployment.v1beta2.DeploymentID";
/**
 * JSON serialization of `akash.deployment.v1beta2.DeploymentID` - stores owner and sequence number
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_DEPLOYMENT = "/akash.deployment.v1beta2.Deployment";
/**
 * JSON serialization of `akash.deployment.v1beta2.Deployment` - stores deploymentID, state and version details
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_DEPLOYMENT_FILTERS = "/akash.deployment.v1beta2.DeploymentFilters";
/**
 * JSON serialization of `akash.deployment.v1beta2.DeploymentFilters` - defines filters used to filter deployments
 */
...
/**
 * Protobuf enum value for `akash.deployment.v1beta2.Deployment.State`.
 *
 * **invalid** -
 *
...
/**
 * JSON enum value for `akash.deployment.v1beta2.Deployment.State`.
 *
 * **invalid** -
 *
...
/**
 * Raw protobuf enum values for `akash.deployment.v1beta2.Deployment.State` to be used when passing to an encoder or comparing to a decoded protobuf value.
 *
 * Values:
...
/**
 * JSON enum values for `akash.deployment.v1beta2.Deployment.State` to be used when passing to a gRPC-gateway method or comparing to a response value
 *
 * Values:
...
/**
 * Maps a protobuf enum int value for `akash.deployment.v1beta2.Deployment.State` to is JSON equivalent enum string value
 */
...
/**
 * Maps a JSON enum string value for `akash.deployment.v1beta2.Deployment.State` to is protobuf equivalent enum int value
 */
