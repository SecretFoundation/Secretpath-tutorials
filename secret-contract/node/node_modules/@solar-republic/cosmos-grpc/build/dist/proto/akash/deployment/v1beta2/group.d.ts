...
export type EncodedAkashDeploymentGroup = Encoded<'/akash.deployment.v1beta2.Group'>;
/**
 ...
 */
export declare const encodeAkashDeploymentGroup: (atu8_group_id?: Opt<Encoded<'/akash.deployment.v1beta2.GroupID'>>, xc_state?: Opt<ProtoEnumAkashDeploymentGroupState>, atu8_group_spec?: Opt<Encoded<'/akash.deployment.v1beta2.GroupSpec'>>, sg_created_at?: Opt<WeakInt64Str>) => EncodedAkashDeploymentGroup;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_GROUP = "/akash.deployment.v1beta2.Group";
/**
 * JSON serialization of `akash.deployment.v1beta2.Group` - stores group id, state and specifications of group
 */
...
/**
 * Raw protobuf enum values for `akash.deployment.v1beta2.Group.State` to be used when passing to an encoder or comparing to a decoded protobuf value.
 *
 * Values:
...
/**
 * JSON enum values for `akash.deployment.v1beta2.Group.State` to be used when passing to a gRPC-gateway method or comparing to a response value
 *
 * Values:
