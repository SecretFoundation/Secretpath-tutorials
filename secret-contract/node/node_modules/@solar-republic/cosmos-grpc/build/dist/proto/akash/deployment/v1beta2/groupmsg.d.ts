...
export type EncodedAkashDeploymentMsgCloseGroup = Encoded<'/akash.deployment.v1beta2.MsgCloseGroup'>;
export type EncodedAkashDeploymentMsgCloseGroupResponse = Encoded<'/akash.deployment.v1beta2.MsgCloseGroupResponse'>;
export type EncodedAkashDeploymentMsgPauseGroup = Encoded<'/akash.deployment.v1beta2.MsgPauseGroup'>;
export type EncodedAkashDeploymentMsgPauseGroupResponse = Encoded<'/akash.deployment.v1beta2.MsgPauseGroupResponse'>;
export type EncodedAkashDeploymentMsgStartGroup = Encoded<'/akash.deployment.v1beta2.MsgStartGroup'>;
export type EncodedAkashDeploymentMsgStartGroupResponse = Encoded<'/akash.deployment.v1beta2.MsgStartGroupResponse'>;
/**
 * Encodes a `MsgCloseGroup` protobuf message: defines SDK message to close a single Group within a Deployment.
 * @param g_id - `id`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentMsgCloseGroup: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta2.GroupID'>>) => EncodedAkashDeploymentMsgCloseGroup;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentMsgPauseGroup: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta2.GroupID'>>) => EncodedAkashDeploymentMsgPauseGroup;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentMsgStartGroup: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta2.GroupID'>>) => EncodedAkashDeploymentMsgStartGroup;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_CLOSE_GROUP = "/akash.deployment.v1beta2.MsgCloseGroup";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgCloseGroup` - defines SDK message to close a single Group within a Deployment.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_CLOSE_GROUP_RESPONSE = "/akash.deployment.v1beta2.MsgCloseGroupResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgCloseGroupResponse` - defines the Msg/CloseGroup response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_PAUSE_GROUP = "/akash.deployment.v1beta2.MsgPauseGroup";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgPauseGroup` - defines SDK message to close a single Group within a Deployment.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_PAUSE_GROUP_RESPONSE = "/akash.deployment.v1beta2.MsgPauseGroupResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgPauseGroupResponse` - defines the Msg/PauseGroup response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_START_GROUP = "/akash.deployment.v1beta2.MsgStartGroup";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgStartGroup` - defines SDK message to close a single Group within a Deployment.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_MSG_START_GROUP_RESPONSE = "/akash.deployment.v1beta2.MsgStartGroupResponse";
/**
 * JSON serialization of `akash.deployment.v1beta2.MsgStartGroupResponse` - defines the Msg/StartGroup response type.
 */
