...
export type EncodedAkashDeploymentGroupID = Encoded<'/akash.deployment.v1beta3.GroupID'>;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_GROUP_I_D = "/akash.deployment.v1beta3.GroupID";
/**
 * JSON serialization of `akash.deployment.v1beta3.GroupID` - stores owner, deployment sequence number and group sequence number
 */
