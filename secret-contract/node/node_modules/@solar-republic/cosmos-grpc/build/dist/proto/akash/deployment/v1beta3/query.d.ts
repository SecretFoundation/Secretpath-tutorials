...
import type { AkashEscrowAccount, DecodedAkashEscrowAccount } from '../../escrow/v1beta3/types.js';
...
export type EncodedAkashDeploymentQueryDeploymentsRequest = Encoded<'/akash.deployment.v1beta3.QueryDeploymentsRequest'>;
export type EncodedAkashDeploymentQueryDeploymentsResponse = Encoded<'/akash.deployment.v1beta3.QueryDeploymentsResponse'>;
export type EncodedAkashDeploymentQueryDeploymentRequest = Encoded<'/akash.deployment.v1beta3.QueryDeploymentRequest'>;
export type EncodedAkashDeploymentQueryDeploymentResponse = Encoded<'/akash.deployment.v1beta3.QueryDeploymentResponse'>;
export type EncodedAkashDeploymentQueryGroupRequest = Encoded<'/akash.deployment.v1beta3.QueryGroupRequest'>;
export type EncodedAkashDeploymentQueryGroupResponse = Encoded<'/akash.deployment.v1beta3.QueryGroupResponse'>;
/**
 * Queries deployments
 ...
 */
export declare const encodeAkashDeploymentQueryDeploymentsRequest: (atu8_filters?: Opt<Encoded<'/akash.deployment.v1beta3.DeploymentFilters'>>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageRequest'>>) => EncodedAkashDeploymentQueryDeploymentsRequest;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryDeploymentsResponse: (a_deployments?: Opt<Encoded<'/akash.deployment.v1beta3.QueryDeploymentResponse'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashDeploymentQueryDeploymentsResponse;
/**
 * Encodes a `QueryDeploymentRequest` protobuf message: request type for the Query/Deployment RPC method
 * @param g_id - `id`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryDeploymentRequest: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta3.DeploymentID'>>) => EncodedAkashDeploymentQueryDeploymentRequest;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryDeploymentResponse: (atu8_deployment?: Opt<Encoded<'/akash.deployment.v1beta3.Deployment'>>, a_groups?: Opt<Encoded<'/akash.deployment.v1beta3.Group'>[]>, atu8_escrow_account?: Opt<Encoded<'/akash.escrow.v1beta3.Account'>>) => EncodedAkashDeploymentQueryDeploymentResponse;
/**
 * Encodes a `QueryGroupRequest` protobuf message: request type for the Query/Group RPC method
 * @param g_id - `id`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryGroupRequest: (atu8_id?: Opt<Encoded<'/akash.deployment.v1beta3.GroupID'>>) => EncodedAkashDeploymentQueryGroupRequest;
/**
 * Encodes a `QueryGroupResponse` protobuf message: response type for the Query/Group RPC method
 * @param g_group - `group`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashDeploymentQueryGroupResponse: (atu8_group?: Opt<Encoded<'/akash.deployment.v1beta3.Group'>>) => EncodedAkashDeploymentQueryGroupResponse;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENTS_REQUEST = "/akash.deployment.v1beta3.QueryDeploymentsRequest";
/**
 * JSON serialization of `akash.deployment.v1beta3.QueryDeploymentsRequest` - request type for the Query/Deployments RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENTS_RESPONSE = "/akash.deployment.v1beta3.QueryDeploymentsResponse";
/**
 * JSON serialization of `akash.deployment.v1beta3.QueryDeploymentsResponse` - response type for the Query/Deployments RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENT_RESPONSE = "/akash.deployment.v1beta3.QueryDeploymentResponse";
/**
 * JSON serialization of `akash.deployment.v1beta3.QueryDeploymentResponse` - response type for the Query/Deployment RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_DEPLOYMENT_REQUEST = "/akash.deployment.v1beta3.QueryDeploymentRequest";
/**
 * JSON serialization of `akash.deployment.v1beta3.QueryDeploymentRequest` - request type for the Query/Deployment RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_GROUP_REQUEST = "/akash.deployment.v1beta3.QueryGroupRequest";
/**
 * JSON serialization of `akash.deployment.v1beta3.QueryGroupRequest` - request type for the Query/Group RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_DEPLOYMENT_QUERY_GROUP_RESPONSE = "/akash.deployment.v1beta3.QueryGroupResponse";
/**
 * JSON serialization of `akash.deployment.v1beta3.QueryGroupResponse` - response type for the Query/Group RPC method
 */
