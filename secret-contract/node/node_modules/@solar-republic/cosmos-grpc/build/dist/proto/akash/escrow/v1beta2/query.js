...
import { decodeAkashEscrowAccount, decodeAkashEscrowFractionalPayment } from './types.js';
import { decodeCosmosBaseQueryPageRequest, decodeCosmosBaseQueryPageResponse } from '../../../cosmos/base/query/v1beta1/pagination.js';
const SR_LCD_AKASH_ESCROW_QUERY = '/akash/escrow/v1beta2/types/';
/**
...
export const encodeAkashEscrowQueryPaymentsResponse = (a_payments, atu8_pagination) => Protobuf() // ...
    .B(a_payments) // FractionalPayment[] payments = 1
    .b(atu8_pagination) // PageResponse pagination = 2
    .o;
/**
 ...
 */
export const decodeAkashEscrowQueryPaymentsResponse = (atu8_payload) => decode_protobuf(atu8_payload, [0, 1], [decodeAkashEscrowFractionalPayment, decodeCosmosBaseQueryPageResponse]);
/**
 ...
 */
export const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_ACCOUNTS_REQUEST = '/akash.escrow.v1beta2.QueryAccountsRequest';
/**
 ...
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_ACCOUNTS_RESPONSE = '/akash.escrow.v1beta2.QueryAccountsResponse';
/**
 ...
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_PAYMENTS_REQUEST = '/akash.escrow.v1beta2.QueryPaymentsRequest';
/**
 ...
 * Message type string constant
 */
export const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_PAYMENTS_RESPONSE = '/akash.escrow.v1beta2.QueryPaymentsResponse';
