...
export type EncodedAkashEscrowQueryAccountsRequest = Encoded<'/akash.escrow.v1beta3.QueryAccountsRequest'>;
export type EncodedAkashEscrowQueryAccountsResponse = Encoded<'/akash.escrow.v1beta3.QueryAccountsResponse'>;
export type EncodedAkashEscrowQueryPaymentsRequest = Encoded<'/akash.escrow.v1beta3.QueryPaymentsRequest'>;
export type EncodedAkashEscrowQueryPaymentsResponse = Encoded<'/akash.escrow.v1beta3.QueryPaymentsResponse'>;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashEscrowQueryAccountsResponse: (a_accounts?: Opt<Encoded<'/akash.escrow.v1beta3.Account'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashEscrowQueryAccountsResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashEscrowQueryPaymentsResponse: (a_payments?: Opt<Encoded<'/akash.escrow.v1beta3.FractionalPayment'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedAkashEscrowQueryPaymentsResponse;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_ACCOUNTS_REQUEST = "/akash.escrow.v1beta3.QueryAccountsRequest";
/**
 * JSON serialization of `akash.escrow.v1beta3.QueryAccountsRequest` - QueryAccountRequest is request type for the Query/Account RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_ACCOUNTS_RESPONSE = "/akash.escrow.v1beta3.QueryAccountsResponse";
/**
 * JSON serialization of `akash.escrow.v1beta3.QueryAccountsResponse` - QueryProvidersResponse is response type for the Query/Providers RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_PAYMENTS_REQUEST = "/akash.escrow.v1beta3.QueryPaymentsRequest";
/**
 * JSON serialization of `akash.escrow.v1beta3.QueryPaymentsRequest` - QueryPaymentRequest is request type for the Query/Payment RPC method
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_ESCROW_QUERY_PAYMENTS_RESPONSE = "/akash.escrow.v1beta3.QueryPaymentsResponse";
/**
 * JSON serialization of `akash.escrow.v1beta3.QueryPaymentsResponse` - QueryProvidersResponse is response type for the Query/Providers RPC method
 */
