...
export type EncodedAkashMarketMsgCreateBid = Encoded<'/akash.market.v1beta3.MsgCreateBid'>;
export type EncodedAkashMarketMsgCreateBidResponse = Encoded<'/akash.market.v1beta3.MsgCreateBidResponse'>;
export type EncodedAkashMarketMsgCloseBid = Encoded<'/akash.market.v1beta3.MsgCloseBid'>;
export type EncodedAkashMarketMsgCloseBidResponse = Encoded<'/akash.market.v1beta3.MsgCloseBidResponse'>;
export type EncodedAkashMarketBidID = Encoded<'/akash.market.v1beta3.BidID'>;
export type EncodedAkashMarketBid = Encoded<'/akash.market.v1beta3.Bid'>;
export type EncodedAkashMarketBidFilters = Encoded<'/akash.market.v1beta3.BidFilters'>;
/**
 ...
 */
export declare const encodeAkashMarketMsgCreateBid: (atu8_order?: Opt<Encoded<'/akash.market.v1beta3.OrderID'>>, s_provider?: Opt<string>, atu8_price?: Opt<Encoded<'/cosmos.base.v1beta1.DecCoin'>>, a_deposit?: Opt<SlimCoin>) => EncodedAkashMarketMsgCreateBid;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashMarketMsgCloseBid: (atu8_bid_id?: Opt<Encoded<'/akash.market.v1beta3.BidID'>>) => EncodedAkashMarketMsgCloseBid;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeAkashMarketBid: (atu8_bid_id?: Opt<Encoded<'/akash.market.v1beta3.BidID'>>, xc_state?: Opt<ProtoEnumAkashMarketBidState>, atu8_price?: Opt<Encoded<'/cosmos.base.v1beta1.DecCoin'>>, sg_created_at?: Opt<WeakInt64Str>) => EncodedAkashMarketBid;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_MSG_CREATE_BID = "/akash.market.v1beta3.MsgCreateBid";
/**
 * JSON serialization of `akash.market.v1beta3.MsgCreateBid` - defines an SDK message for creating Bid
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_MSG_CREATE_BID_RESPONSE = "/akash.market.v1beta3.MsgCreateBidResponse";
/**
 * JSON serialization of `akash.market.v1beta3.MsgCreateBidResponse` - defines the Msg/CreateBid response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_MSG_CLOSE_BID = "/akash.market.v1beta3.MsgCloseBid";
/**
 * JSON serialization of `akash.market.v1beta3.MsgCloseBid` - defines an SDK message for closing bid
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_BID_I_D = "/akash.market.v1beta3.BidID";
/**
 * JSON serialization of `akash.market.v1beta3.BidID` - stores owner and all other seq numbers A successful bid becomes a Lease(ID).
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_MSG_CLOSE_BID_RESPONSE = "/akash.market.v1beta3.MsgCloseBidResponse";
/**
 * JSON serialization of `akash.market.v1beta3.MsgCloseBidResponse` - defines the Msg/CloseBid response type.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_BID = "/akash.market.v1beta3.Bid";
/**
 * JSON serialization of `akash.market.v1beta3.Bid` - stores BidID, state of bid and price
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_AKASH_MARKET_BID_FILTERS = "/akash.market.v1beta3.BidFilters";
/**
 * JSON serialization of `akash.market.v1beta3.BidFilters` - defines flags for bid list filter
 */
...
/**
 * Raw protobuf enum values for `akash.market.v1beta3.Bid.State` to be used when passing to an encoder or comparing to a decoded protobuf value.
 *
 * Values:
...
/**
 * JSON enum values for `akash.market.v1beta3.Bid.State` to be used when passing to a gRPC-gateway method or comparing to a response value
 *
 * Values:
