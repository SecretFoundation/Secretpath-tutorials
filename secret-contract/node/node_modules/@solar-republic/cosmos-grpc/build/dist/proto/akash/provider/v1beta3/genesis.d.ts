...
export type EncodedAkashProviderGenesisState = Encoded<'/akash.provider.v1beta3.GenesisState'>;
/**
 ...
 */
export declare const encodeAkashProviderGenesisState: (a_providers?: Opt<Encoded<'/akash.provider.v1beta3.Provider'>[]>) => EncodedAkashProviderGenesisState;
/**
 ...
 */
export declare const SI_MESSAGE_TYPE_AKASH_PROVIDER_GENESIS_STATE = "/akash.provider.v1beta3.GenesisState";
/**
 * JSON serialization of `akash.provider.v1beta3.GenesisState` - defines the basic genesis state used by provider module
 */
