...
import type { CosmosGovProposal, DecodedCosmosGovProposal, ProtoEnumCosmosGovProposalStatus, JsonEnumCosmosGovProposalStatus, CosmosGovVote, DecodedCosmosGovVote, CosmosGovVotingParams, DecodedCosmosGovVotingParams, CosmosGovDepositParams, DecodedCosmosGovDepositParams, CosmosGovTallyParams, DecodedCosmosGovTallyParams, CosmosGovParams, DecodedCosmosGovParams, CosmosGovDeposit, DecodedCosmosGovDeposit, CosmosGovTallyResult, DecodedCosmosGovTallyResult } from './gov.js';
export type EncodedCosmosGovQueryConstitutionRequest = Encoded<'/cosmos.gov.v1.QueryConstitutionRequest'>;
export type EncodedCosmosGovQueryConstitutionResponse = Encoded<'/cosmos.gov.v1.QueryConstitutionResponse'>;
export type EncodedCosmosGovQueryProposalRequest = Encoded<'/cosmos.gov.v1.QueryProposalRequest'>;
export type EncodedCosmosGovQueryProposalResponse = Encoded<'/cosmos.gov.v1.QueryProposalResponse'>;
export type EncodedCosmosGovQueryProposalsRequest = Encoded<'/cosmos.gov.v1.QueryProposalsRequest'>;
export type EncodedCosmosGovQueryProposalsResponse = Encoded<'/cosmos.gov.v1.QueryProposalsResponse'>;
export type EncodedCosmosGovQueryVoteRequest = Encoded<'/cosmos.gov.v1.QueryVoteRequest'>;
export type EncodedCosmosGovQueryVoteResponse = Encoded<'/cosmos.gov.v1.QueryVoteResponse'>;
export type EncodedCosmosGovQueryVotesRequest = Encoded<'/cosmos.gov.v1.QueryVotesRequest'>;
export type EncodedCosmosGovQueryVotesResponse = Encoded<'/cosmos.gov.v1.QueryVotesResponse'>;
export type EncodedCosmosGovQueryParamsRequest = Encoded<'/cosmos.gov.v1.QueryParamsRequest'>;
export type EncodedCosmosGovQueryParamsResponse = Encoded<'/cosmos.gov.v1.QueryParamsResponse'>;
export type EncodedCosmosGovQueryDepositRequest = Encoded<'/cosmos.gov.v1.QueryDepositRequest'>;
export type EncodedCosmosGovQueryDepositResponse = Encoded<'/cosmos.gov.v1.QueryDepositResponse'>;
export type EncodedCosmosGovQueryDepositsRequest = Encoded<'/cosmos.gov.v1.QueryDepositsRequest'>;
export type EncodedCosmosGovQueryDepositsResponse = Encoded<'/cosmos.gov.v1.QueryDepositsResponse'>;
export type EncodedCosmosGovQueryTallyResultRequest = Encoded<'/cosmos.gov.v1.QueryTallyResultRequest'>;
export type EncodedCosmosGovQueryTallyResultResponse = Encoded<'/cosmos.gov.v1.QueryTallyResultResponse'>;
/**
 * Queries the chain's constitution.
 * @param z_req - URL origin of LCD endpoint or {@link RequestInit}
 * @returns a tuple where:
 *   - 0: constitution - the 'constitution' response property
 */
export declare const queryCosmosGovConstitution: (z_req: string | ({
    origin: string;
} & RequestInit)) => Promise<import("../../../../api/transport.js").NetworkJsonResponse<CosmosGovQueryConstitutionResponse>>;
/**
 * Queries proposal details based on ProposalID.
 * @param z_req - URL origin of LCD endpoint or {@link RequestInit}
 * @param sg_proposal_id - defines the unique id of the proposal.
 * @returns a tuple where:
 *   - 0: proposal - the requested governance proposal.
 */
 ...
 * @returns a tuple where:
 *   - 0: voting_params - Deprecated: Prefer to use `params` instead. voting_params defines the parameters related to voting.
 *   - 1: deposit_params - Deprecated: Prefer to use `params` instead. voting_params defines the parameters related to voting.
 *   - 2: tally_params - Deprecated: Prefer to use `params` instead. voting_params defines the parameters related to voting.
 *   - 3: params - Deprecated: Prefer to use `params` instead. voting_params defines the parameters related to voting.
 */
...
/**
 * Encodes a `QueryConstitutionRequest` protobuf message: the request type for the Query/Constitution RPC method
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryConstitutionRequest: () => EncodedCosmosGovQueryConstitutionRequest;
/**
 * Encodes a `QueryConstitutionResponse` protobuf message: the response type for the Query/Constitution RPC method
 * @param s_constitution - `constitution`:
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryConstitutionResponse: (s_constitution?: Opt<string>) => EncodedCosmosGovQueryConstitutionResponse;
/**
 ...
 * @param g_proposal - `proposal`: the requested governance proposal.
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryProposalResponse: (atu8_proposal?: Opt<Encoded<'/cosmos.gov.v1.Proposal'>>) => EncodedCosmosGovQueryProposalResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryProposalsResponse: (a_proposals?: Opt<Encoded<'/cosmos.gov.v1.Proposal'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedCosmosGovQueryProposalsResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryVoteResponse: (atu8_vote?: Opt<Encoded<'/cosmos.gov.v1.Vote'>>) => EncodedCosmosGovQueryVoteResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryVotesResponse: (a_votes?: Opt<Encoded<'/cosmos.gov.v1.Vote'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedCosmosGovQueryVotesResponse;
/**
 ...
 * @param g_voting_params - `voting_params`: Deprecated: Prefer to use `params` instead. voting_params defines the parameters related to voting.
 * @param g_deposit_params - `deposit_params`: Deprecated: Prefer to use `params` instead. deposit_params defines the parameters related to deposit.
 * @param g_tally_params - `tally_params`: Deprecated: Prefer to use `params` instead. tally_params defines the parameters related to tally.
 * @param g_params - `params`: defines all the paramaters of x/gov module. Since: cosmos-sdk 0.47
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryParamsResponse: (atu8_voting_params?: Opt<Encoded<'/cosmos.gov.v1.VotingParams'>>, atu8_deposit_params?: Opt<Encoded<'/cosmos.gov.v1.DepositParams'>>, atu8_tally_params?: Opt<Encoded<'/cosmos.gov.v1.TallyParams'>>, atu8_params?: Opt<Encoded<'/cosmos.gov.v1.Params'>>) => EncodedCosmosGovQueryParamsResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryDepositResponse: (atu8_deposit?: Opt<Encoded<'/cosmos.gov.v1.Deposit'>>) => EncodedCosmosGovQueryDepositResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryDepositsResponse: (a_deposits?: Opt<Encoded<'/cosmos.gov.v1.Deposit'>[]>, atu8_pagination?: Opt<Encoded<'/cosmos.base.query.v1beta1.PageResponse'>>) => EncodedCosmosGovQueryDepositsResponse;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeCosmosGovQueryTallyResultResponse: (atu8_tally?: Opt<Encoded<'/cosmos.gov.v1.TallyResult'>>) => EncodedCosmosGovQueryTallyResultResponse;
/**
 * A decoded protobuf QueryConstitutionRequest message
 *
 * Tuple where:
 */
export type DecodedCosmosGovQueryConstitutionRequest = [];
/**
 * Decodes a protobuf QueryConstitutionRequest message
 * @param atu8_payload - raw bytes to decode
 * @returns a {@link DecodedCosmosGovQueryConstitutionRequest}
 */
export declare const decodeCosmosGovQueryConstitutionRequest: (atu8_payload: Uint8Array) => [];
/**
 * A decoded protobuf QueryConstitution message
 *
 * Alias for: constitution -
 */
export type DecodedCosmosGovQueryConstitutionResponse = [
    s_constitution?: string
];
/**
 * Decodes a protobuf QueryConstitution message
 * @param atu8_payload - raw bytes to decode
 * @returns a {@link DecodedCosmosGovQueryConstitutionResponse}
 */
export declare const decodeCosmosGovQueryConstitutionResponse: (atu8_payload: Uint8Array) => DecodedCosmosGovQueryConstitutionResponse;
/**
 ...
 *
 * Alias for: proposal - the requested governance proposal.
 */
 ...
 * Tuple where:
 *   - 0: voting_params - Deprecated: Prefer to use `params` instead. voting_params defines the parameters related to voting.
 *   - 1: deposit_params - Deprecated: Prefer to use `params` instead. deposit_params defines the parameters related to deposit.
 *   - 2: tally_params - Deprecated: Prefer to use `params` instead. tally_params defines the parameters related to tally.
 *   - 3: params - defines all the paramaters of x/gov module. Since: cosmos-sdk 0.47
 */
...
/**
 * Destructures the fields of a {@link CosmosGovQueryConstitutionRequest} JSON message into a tuple of parsed ES equivalents
 * @param g_struct - the JSON message
 * @returns a tuple where:
 */
export declare const destructCosmosGovQueryConstitutionRequest: (g_struct: CosmosGovQueryConstitutionRequest) => [];
/**
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_CONSTITUTION_REQUEST = "/cosmos.gov.v1.QueryConstitutionRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryConstitutionRequest` - the request type for the Query/Constitution RPC method
 */
export type CosmosGovQueryConstitutionRequest = {};
/**
 * Destructures the fields of a {@link CosmosGovQueryConstitutionResponse} JSON message into a tuple of parsed ES equivalents
 * @param g_struct - the JSON message
 * @returns a tuple where:
 *   - 0: constitution -
 */
export declare const destructCosmosGovQueryConstitutionResponse: (g_struct: CosmosGovQueryConstitutionResponse) => [constitution?: string];
/**
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_CONSTITUTION_RESPONSE = "/cosmos.gov.v1.QueryConstitutionResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryConstitutionResponse` - the response type for the Query/Constitution RPC method
 */
export type CosmosGovQueryConstitutionResponse = {
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_PROPOSAL_REQUEST = "/cosmos.gov.v1.QueryProposalRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryProposalRequest` - the request type for the Query/Proposal RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_PROPOSAL_RESPONSE = "/cosmos.gov.v1.QueryProposalResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryProposalResponse` - the response type for the Query/Proposal RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_PROPOSALS_REQUEST = "/cosmos.gov.v1.QueryProposalsRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryProposalsRequest` - the request type for the Query/Proposals RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_PROPOSALS_RESPONSE = "/cosmos.gov.v1.QueryProposalsResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryProposalsResponse` - the response type for the Query/Proposals RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_VOTE_REQUEST = "/cosmos.gov.v1.QueryVoteRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryVoteRequest` - the request type for the Query/Vote RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_VOTE_RESPONSE = "/cosmos.gov.v1.QueryVoteResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryVoteResponse` - the response type for the Query/Vote RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_VOTES_REQUEST = "/cosmos.gov.v1.QueryVotesRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryVotesRequest` - the request type for the Query/Votes RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_VOTES_RESPONSE = "/cosmos.gov.v1.QueryVotesResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryVotesResponse` - the response type for the Query/Votes RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_PARAMS_REQUEST = "/cosmos.gov.v1.QueryParamsRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryParamsRequest` - the request type for the Query/Params RPC method.
 */
 ...
 *   - 3: params - defines all the paramaters of x/gov module. Since: cosmos-sdk 0.47
 */
export declare const destructCosmosGovQueryParamsResponse: (g_struct: CosmosGovQueryParamsResponse) => [voting_params?: CosmosGovVotingParams, deposit_params?: CosmosGovDepositParams, tally_params?: CosmosGovTallyParams, params?: CosmosGovParams];
/**
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_PARAMS_RESPONSE = "/cosmos.gov.v1.QueryParamsResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryParamsResponse` - the response type for the Query/Params RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_DEPOSIT_REQUEST = "/cosmos.gov.v1.QueryDepositRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryDepositRequest` - the request type for the Query/Deposit RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_DEPOSIT_RESPONSE = "/cosmos.gov.v1.QueryDepositResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryDepositResponse` - the response type for the Query/Deposit RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_DEPOSITS_REQUEST = "/cosmos.gov.v1.QueryDepositsRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryDepositsRequest` - the request type for the Query/Deposits RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_DEPOSITS_RESPONSE = "/cosmos.gov.v1.QueryDepositsResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryDepositsResponse` - the response type for the Query/Deposits RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_TALLY_RESULT_REQUEST = "/cosmos.gov.v1.QueryTallyResultRequest";
/**
 * JSON serialization of `cosmos.gov.v1.QueryTallyResultRequest` - the request type for the Query/Tally RPC method.
 */
 ...
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_COSMOS_GOV_QUERY_TALLY_RESULT_RESPONSE = "/cosmos.gov.v1.QueryTallyResultResponse";
/**
 * JSON serialization of `cosmos.gov.v1.QueryTallyResultResponse` - the response type for the Query/Tally RPC method.
 */
