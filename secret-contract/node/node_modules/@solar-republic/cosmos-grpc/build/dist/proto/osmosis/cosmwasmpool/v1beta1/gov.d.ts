...
export type EncodedOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal = Encoded<'/osmosis.cosmwasmpool.v1beta1.UploadCosmWasmPoolCodeAndWhiteListProposal'>;
export type EncodedOsmosisCosmwasmpoolMigratePoolContractsProposal = Encoded<'/osmosis.cosmwasmpool.v1beta1.MigratePoolContractsProposal'>;
/**
 ...
 */
export declare const encodeOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal: (s_title?: Opt<string>, s_description?: Opt<string>, atu8_wasm_byte_code?: Opt<Uint8Array>) => EncodedOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal;
/**
 ...
 * @returns a strongly subtyped Uint8Array protobuf message
 */
export declare const encodeOsmosisCosmwasmpoolMigratePoolContractsProposal: (s_title?: Opt<string>, s_description?: Opt<string>, a_pool_ids?: Opt<WeakUint64Str[]>, sg_new_code_id?: Opt<WeakUint64Str>, atu8_wasm_byte_code?: Opt<Uint8Array>, atu8_migrate_msg?: Opt<Uint8Array>) => EncodedOsmosisCosmwasmpoolMigratePoolContractsProposal;
/**
 * A decoded protobuf UploadCosmWasmPoolCodeAndWhiteListProposal message
 *
 * Tuple where:
 *   - 0: title -
 *   - 1: description -
 ...
 */
export type DecodedOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal = [
    s_title?: string,
 ...
 */
export declare const decodeOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal: (atu8_payload: Uint8Array) => DecodedOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal;
/**
 * A decoded protobuf MigratePoolContractsProposal message
 *
 * Tuple where:
 *   - 0: title -
 *   - 1: description -
 ...
 */
export type DecodedOsmosisCosmwasmpoolMigratePoolContractsProposal = [
    s_title?: string,
    s_description?: string,
    a_pool_ids?: CwUint64[],
    sg_new_code_id?: CwUint64,
    atu8_wasm_byte_code?: Uint8Array,
    atu8_migrate_msg?: Uint8Array
];
/**
 ...
 */
export declare const decodeOsmosisCosmwasmpoolMigratePoolContractsProposal: (atu8_payload: Uint8Array) => DecodedOsmosisCosmwasmpoolMigratePoolContractsProposal;
/**
 ...
 *   - 2: wasm_byte_code - WASMByteCode can be raw or gzip compressed
 */
export declare const destructOsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal: (g_struct: OsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal) => [title?: string, description?: string, wasm_byte_code?: Uint8Array];
/**
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_OSMOSIS_COSMWASMPOOL_UPLOAD_COSM_WASM_POOL_CODE_AND_WHITE_LIST_PROPOSAL = "/osmosis.cosmwasmpool.v1beta1.UploadCosmWasmPoolCodeAndWhiteListProposal";
/**
 * JSON serialization of `osmosis.cosmwasmpool.v1beta1.UploadCosmWasmPoolCodeAndWhiteListProposal` - a gov Content type for uploading coswasm pool code and adding it to internal whitelist. Only the code ids created by this message are eligible for being x/cosmwasmpool pools.
 */
export type OsmosisCosmwasmpoolUploadCosmWasmPoolCodeAndWhiteListProposal = {
 ...
 *   - 5: migrate_msg - MigrateMsg migrate message to be used for migrating the pool contracts.
 */
export declare const destructOsmosisCosmwasmpoolMigratePoolContractsProposal: (g_struct: OsmosisCosmwasmpoolMigratePoolContractsProposal) => [title?: string, description?: string, pool_ids?: CwUint64[], new_code_id?: CwUint64, wasm_byte_code?: Uint8Array, migrate_msg?: Uint8Array];
/**
 * Message type string constant
 */
export declare const SI_MESSAGE_TYPE_OSMOSIS_COSMWASMPOOL_MIGRATE_POOL_CONTRACTS_PROPOSAL = "/osmosis.cosmwasmpool.v1beta1.MigratePoolContractsProposal";
/**
 * JSON serialization of `osmosis.cosmwasmpool.v1beta1.MigratePoolContractsProposal` - a gov Content type for migrating  given pools to the new contract code and adding to internal whitelist if needed. It has two options to perform the migration: 1. If the codeID is non-zero, it will migrate the pool contracts to a given codeID assuming that it has already been uploaded. uploadByteCode must be empty in such a case. Fails if codeID does not exist. Fails if uploadByteCode is not empty. 2. If the codeID is zero, it will upload the given uploadByteCode and use the new resulting code id to migrate the pool to. Errors if uploadByteCode is empty or invalid. In both cases, if one of the pools specified by the given poolID does not exist, the proposal fails. The reason for having poolIDs be a slice of ids is to account for the potential need for emergency migration of all old code ids associated with particular pools to new code ids, or simply having the flexibility of migrating multiple older pool contracts to a new one at once when there is a release. poolD count to be submitted at once is gated by a governance paramets (20 at launch). The proposal fails if more. Note that 20 was chosen arbitrarily to have a constant bound on the number of pools migrated at once. This size will be configured by a module parameter so it can be changed by a constant.
 */
export type OsmosisCosmwasmpoolMigratePoolContractsProposal = {
    title?: string | undefined;
    description?: string | undefined;
    pool_ids?: CwUint64[] | undefined;
    new_code_id?: CwUint64 | undefined;
    wasm_byte_code?: CwBase64 | undefined;
    migrate_msg?: CwBase64 | undefined;
};
