import { zero_out } from '@blake.regalia/belt';
import { SensitiveBytes } from './sensitive-bytes.js';
...
export class RuntimeKey {
    ...
    constructor() {
        ...
        const atu8_salt = random_bytes(32);
    ...
    async access(fk_use) {
        ...
        const { dk_base, atu8_salt, kn_xor, ni_bits, } = g_privates;
    ...
    destroy() {
        // destructure fields
        const { atu8_salt, kn_xor, } = hm_privates.get(this);
        // remove otp
        kn_xor?.wipe();
        // clear salt
        zero_out(atu8_salt);
