...
const quarterround = (atu32_d, i_a, i_b, i_c, i_d) => {
    // best gzip option
 ...
 */
export const chacha20 = (atu8_key, atu8_nonce, atu8_data, xn_counter = 0) => {
    // iterator
    let i_each;
    // prepare output
    ...
    for (i_each = 0; i_each < 8; i_each++) {
        ...
        if (i_each < 3)
            a_words_nonce[i_each] = dv_nonce.getUint32(i_each * 4, true);
    }
    // initialize state
